...
class BatchGenerator:
	...
	def store_data_by_score(self):
		...
		np.save(os.path.join(PATH_NUMPY_DATA_SCORE_1_CH), score_1_data)
		np.save(os.path.join(PATH_NUMPY_DATA_SCORE_2_CH), score_2_data)
		np.save(os.path.join(PATH_NUMPY_DATA_SCORE_3_CH), score_3_data)
		np.save(os.path.join(PATH_NUMPY_DATA_SCORE_4_CH), score_4_data)
		
		np.save(os.path.join(PATH_NUMPY_DATA_SCORE_1_labels_CH), score_1_masks)
		np.save(os.path.join(PATH_NUMPY_DATA_SCORE_2_labels_CH), score_2_masks)
		np.save(os.path.join(PATH_NUMPY_DATA_SCORE_3_labels_CH), score_3_masks)
		np.save(os.path.join(PATH_NUMPY_DATA_SCORE_4_labels_CH), score_4_masks)
